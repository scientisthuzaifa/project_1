...
namespace Aptech_Final_E_project.Controllers
{
    public class AnnouncementsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,title,description,dateposted")] Announcement announcement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,title,description,dateposted")] Announcement announcement)
        {
            if (ModelState.IsValid)
            {
